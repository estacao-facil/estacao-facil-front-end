...
Este repositório contém a implementação do _Front-End, desenvolvido utilizando \*\*Next.js_ e _Tailwind CSS_ para proporcionar uma interface moderna, responsiva e acessível.

O projeto está sendo desenvolvido para a disciplina de _Desenvolvimento Front-End_ da _FIAP, em parceria com a \*\*CCR_, que propôs a criação dessa solução para melhorar a experiência dos passageiros.
...
Este projeto está sendo desenvolvido no âmbito da _FIAP, com apoio da disciplina de \*\*Desenvolvimento Front-End_,
